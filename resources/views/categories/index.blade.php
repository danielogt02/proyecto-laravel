            ...
            @foreach ($categories as $category)
                <div class="row py-1">
                    <div class="col-md-9 d-flex align-items-center">
                        <a class="d-flex align-items-center grap-2" href="{{ route('categories.show', ['category' => $category->id]) }}">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Al eliminar la categoría <strong> {{$category->name}} </strong> se eliminan todas las tareas asignadas a la misma. ¿Estas seguro que desea eliminar la categoria <strong>{{$category->name}} </strong>?</strong></strong>
                            </div>
